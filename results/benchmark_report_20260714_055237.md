...
**Run:** 2026-07-14T05:52:37.274390+00:00
...
|--------|-----------------|----------------|---------------|-------------------|
| James Bot (TalkingDB) | 83.33% | 50.0% | 100.0 | 350.06 |
| ChatGPT (Household AI) | 0.0% | 0.0% | 40.91 | 800.0 |

## James Bot vs Competitor

- Accuracy delta (fuzzy): **50.0%**
...
- [FAIL] `james_bot` **Q002**: fuzzy=80.0, grounding=100.0
...
- [FAIL] `james_bot` **Q015**: fuzzy=12.4, grounding=100.0
